                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-8">
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-6">
                                <a href="https://www.instagram.com/wedsechos/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-black/70 hover:text-black transition-colors"><InstagramIcon /></a>
                                <a href="https://www.facebook.com/profile.php?id=61576426967402" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-black/70 hover:text-black transition-colors"><FacebookIcon /></a>
                                <a href="https://www.youtube.com/@WeddingEcho" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-black/70 hover:text-black transition-colors"><YouTubeIcon /></a>
                            </div>
                        </div>
